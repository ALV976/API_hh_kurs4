from src.api import HeadHunterRuAPI
from src.connector import SaveJson
...
def user_interaction():
    print('''Применяя это приложение поиск вакансий на Hh.ru станет эффективнее:
    ...
    with open('/home/a/PycharmProjects/API__hh_kurs4/data/vacancies.json', 'w') as file:
        json.dump(good_vacancy, file,
                  default=lambda x: x.dict)  # записывает в файл vacancies.json выбранные пользователем вакансии
